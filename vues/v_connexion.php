<div id="contenu">
      ...
      <form method="POST" action="index.php?uc=connexion&action=valideConnexion" class="form-row">
            <div class="form-group mb-4 sm-2">
                  ...
                  <input id="login" class="form-control" type="text" name="login" size="30" maxlength="45" required>

                  <label for="mdp">Mot de passe*</label>
                  <input id="mdp" class="form-control" type="password" name="mdp" size="30" maxlength="45" required>
                  <br>
