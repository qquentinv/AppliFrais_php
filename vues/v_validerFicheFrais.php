...
<div class="encadre">
  <h3 style="margin-left:5px;">
    ...
    if($libEtat == "Fiche créée, saisie en cours" || $libEtat == "Saisie clôturée"){
      echo "<button style='margin-right: 10px; ' id='validation' class='btn btn-success' title='Validation de la fiche' type='submit' onClick='ValiderFiche()'><svg class='bi bi-check-circle' width='1em' height='1em' viewBox='0 0 16 16' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
  ...
  <table class="listeLegere">
    ...
    <tr>
      ...
      ?>
      <td><button id="ok" class="btn btn-primary" title="Corriger fiche frais" type="submit" value="Modifier" onClick="ModifierFF()"><svg class="bi bi-pencil-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="form-group row" style="margin-left: 5px; display:flex; margin-top:20px;">
    ...
    <button id="modif" title="Corriger justification" class="btn btn-primary" type="submit" onClick="ModifierJR()"><svg class="bi bi-pencil-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path d="M15.502 1.94a.5.5 0 010 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 01.707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 00-.121.196l-.805 2.414a.25.25 0 00.316.316l2.414-.805a.5.5 0 00.196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 002.5 15h11a1.5 1.5 0 001.5-1.5v-6a.5.5 0 00-1 0v6a.5.5 0 01-.5.5h-11a.5.5 0 01-.5-.5v-11a.5.5 0 01.5-.5H9a.5.5 0 000-1H2.5A1.5 1.5 0 001 2.5v11z" clip-rule="evenodd"/>
</svg></button>
</h3>
  ...
  <table class="listeLegere">
    ...
    ?>
      <tr>
        ...
        <td>
          <button id="ok" class="btn btn-primary" type="submit" onClick="ModifierLHF(<?php echo $id;
                                                                                      echo ",";
          ...
          <button id="ok" class="btn btn-danger" type="submit" onClick="SupprimerLHF(<?php echo $id ?>)" title='Supprime la fiche de frais'><svg class="bi bi-x-circle" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M8 15A7 7 0 108 1a7 7 0 000 14zm0 1A8 8 0 108 0a8 8 0 000 16z" clip-rule="evenodd"/>
  <path fill-rule="evenodd" d="M11.854 4.146a.5.5 0 010 .708l-7 7a.5.5 0 01-.708-.708l7-7a.5.5 0 01.708 0z" clip-rule="evenodd"/>
  <path fill-rule="evenodd" d="M4.146 4.146a.5.5 0 000 .708l7 7a.5.5 0 00.708-.708l-7-7a.5.5 0 00-.708 0z" clip-rule="evenodd"/>
</svg></button>
          <button id="ok" class="btn btn-secondary" type="reset" onClick="Reinitialiser()" title="Réinitialiser la fiche de frais"><svg class="bi bi-arrow-clockwise" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M8.147.146a.5.5 0 01.707 0l2.5 2.5a.5.5 0 010 .708l-2.5 2.5a.5.5 0 11-.707-.708L10.293 3 8.147.854a.5.5 0 010-.708z" clip-rule="evenodd"/>
          ...
          <button id="ok" class="btn btn-info" type="submit" onClick="ReportLHF(<?php echo $id;
                                                                                      echo ",";
  ...
  <script>
    ...
    function ValiderFiche(){
      ...
      window.location = loc.protocol + '//' + loc.host + loc.pathname + loc.search + "&sure=1";
    }
    // fichefrais
    function ModifierFF() { //fonctionne pas
      ...
      var REP = d[3].value;
      var loc = window.location;
      window.location = loc.protocol + '//' + loc.host + loc.pathname + loc.search + "&ETP=" + ETP + "&KM=" + KM + "&NUI=" + NUI + "&REP=" + REP;
    }
    ...
    function ModifierJR() {
      ...
      var loc = window.location;
      window.location = loc.protocol + '//' + loc.host + loc.pathname + loc.search + "&modifierJR=" + JR.value;
    }
    ...
    function ModifierLHF(id, i) {
      ...
      var loc = window.location;
      window.location = loc.protocol + '//' + loc.host + loc.pathname + loc.search + "&modifyId=" +
        id + "&dateLHF=" + date.value + "&libelleLHF=" + libelle.value + "&montantLHF=" + montant.value;
    }
    ...
    function ReportLHF(id, i) {
      ...
      var loc = window.location;
      window.location = loc.protocol + '//' + loc.host + loc.pathname + loc.search + "&report="+ id + "&LLHF=" + LLHF.value + "&DLHF=" + DLHF.value + "&MLHF=" + MLHF.value;
    }
  </script>
</div>
</div>